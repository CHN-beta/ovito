...
protected:
	...
	Future<PipelineFlowState> postprocessDataCollection(int animationFrame, ObjectInitializationHints initializationHints, TimeInterval frameInterval, Future<PipelineFlowState> future);
