...
enum PropertyFieldFlag
{
	...
	/// Used for property fields of a DataObject.
	PROPERTY_FIELD_DATA_OBJECT					= (1<<13)
};
...
public:
	...
	/// Indicates that the property field belongs to a DataObject.
	bool isDataObjectField() const { return _flags.testFlag(PROPERTY_FIELD_DATA_OBJECT); }
