...
public:
	...
	virtual std::shared_ptr<FileSourceImporter::FrameLoader> createFrameLoader(const Frame& frame, const FileHandle& file) override {
		return std::make_shared<FrameLoader>(dataset(), frame, file, sortParticles(), columnMapping());
	}
...
private:
	...
	public:
		...
		/// Normal constructor.
		FrameLoader(DataSet* dataset, const FileSourceImporter::Frame& frame, const FileHandle& file, bool sortParticles, const ParticleInputColumnMapping& columnMapping)
			: FileSourceImporter::FrameLoader(dataset, frame, file), _sortParticles(sortParticles), _parseFileHeaderOnly(false), _columnMapping(columnMapping) {}
