...
private:
	...
	protected:
		...
		PropertyStorage* createParticlePropertyForDataArray(PropertyContainerImportData& container, size_t particleCount, QXmlStreamReader& xml);

		/// Reads a <DataArray> element and stores it in the given OVITO property.
		void parseDataArray(PropertyStorage* property, QXmlStreamReader& xml);
	};
};
