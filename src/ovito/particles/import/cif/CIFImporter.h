...
class OVITO_PARTICLES_EXPORT CIFImporter : public ParticleImporter
{
	...
	public:
		...
		virtual Ovito::span<const SupportedFormat> supportedFormats() const override {
			static const SupportedFormat formats[] = {{ QStringLiteral("*.cif *.cif.gz"), tr("Crystallographic Information Files") }};
			return formats;
		}
...
public:
	...
	Q_INVOKABLE CIFImporter(ObjectCreationParams params) : ParticleImporter(params) {}
