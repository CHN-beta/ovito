...
******************************************************************************/
void DislocationAnalysisModifier::initializeObject(ObjectInitializationHints hints)
{
	// Create the vis elements.
	setDislocationVis(OORef<DislocationVis>::create(dataset(), hints));

	setDefectMeshVis(OORef<SurfaceMeshVis>::create(dataset(), hints));
	...
	setInterfaceMeshVis(OORef<SurfaceMeshVis>::create(dataset(), hints));
	...
	fccPattern->addBurgersVectorFamily(DataOORef<BurgersVectorFamily>::create(dataset(), hints));
	fccPattern->addBurgersVectorFamily(DataOORef<BurgersVectorFamily>::create(dataset(), hints, 1, tr("1/2<110> (Perfect)"), Vector3(1.0f/2.0f, 1.0f/2.0f, 0.0f), Color(0.2f,0.2f,1)));
	fccPattern->addBurgersVectorFamily(DataOORef<BurgersVectorFamily>::create(dataset(), hints, 2, tr("1/6<112> (Shockley)"), Vector3(1.0f/6.0f, 1.0f/6.0f, 2.0f/6.0f), Color(0,1,0)));
	fccPattern->addBurgersVectorFamily(DataOORef<BurgersVectorFamily>::create(dataset(), hints, 3, tr("1/6<110> (Stair-rod)"), Vector3(1.0f/6.0f, 1.0f/6.0f, 0.0f/6.0f), Color(1,0,1)));
	fccPattern->addBurgersVectorFamily(DataOORef<BurgersVectorFamily>::create(dataset(), hints, 4, tr("1/3<100> (Hirth)"), Vector3(1.0f/3.0f, 0.0f, 0.0f), Color(1,1,0)));
	fccPattern->addBurgersVectorFamily(DataOORef<BurgersVectorFamily>::create(dataset(), hints, 5, tr("1/3<111> (Frank)"), Vector3(1.0f/3.0f, 1.0f/3.0f, 1.0f/3.0f), Color(0,1,1)));
	...
	bccPattern->addBurgersVectorFamily(DataOORef<BurgersVectorFamily>::create(dataset(), hints));
	bccPattern->addBurgersVectorFamily(DataOORef<BurgersVectorFamily>::create(dataset(), hints, 11, tr("1/2<111>"), Vector3(1.0f/2.0f, 1.0f/2.0f, 1.0f/2.0f), Color(0,1,0)));
	bccPattern->addBurgersVectorFamily(DataOORef<BurgersVectorFamily>::create(dataset(), hints, 12, tr("<100>"), Vector3(1.0f, 0.0f, 0.0f), Color(1, 0.3f, 0.8f)));
	bccPattern->addBurgersVectorFamily(DataOORef<BurgersVectorFamily>::create(dataset(), hints, 13, tr("<110>"), Vector3(1.0f, 1.0f, 0.0f), Color(0.2f, 0.5f, 1.0f)));
	...
	hcpPattern->addBurgersVectorFamily(DataOORef<BurgersVectorFamily>::create(dataset(), hints));
	hcpPattern->addBurgersVectorFamily(DataOORef<BurgersVectorFamily>::create(dataset(), hints, 21, tr("1/3<1-210>"), Vector3(sqrt(0.5f), 0.0f, 0.0f), Color(0,1,0)));
	hcpPattern->addBurgersVectorFamily(DataOORef<BurgersVectorFamily>::create(dataset(), hints, 22, tr("<0001>"), Vector3(0.0f, 0.0f, sqrt(4.0f/3.0f)), Color(0.2f,0.2f,1)));
	hcpPattern->addBurgersVectorFamily(DataOORef<BurgersVectorFamily>::create(dataset(), hints, 23, tr("<1-100>"), Vector3(0.0f, sqrt(3.0f/2.0f), 0.0f), Color(1,0,1)));
	hcpPattern->addBurgersVectorFamily(DataOORef<BurgersVectorFamily>::create(dataset(), hints, 24, tr("1/3<1-100>"), Vector3(0.0f, sqrt(3.0f/2.0f)/3.0f, 0.0f), Color(1,0.5f,0)));
	hcpPattern->addBurgersVectorFamily(DataOORef<BurgersVectorFamily>::create(dataset(), hints, 25, tr("1/3<1-213>"), Vector3(sqrt(0.5f), 0.0f, sqrt(4.0f/3.0f)), Color(1,1,0)));
	...
	cubicDiaPattern->addBurgersVectorFamily(DataOORef<BurgersVectorFamily>::create(dataset(), hints));
	cubicDiaPattern->addBurgersVectorFamily(DataOORef<BurgersVectorFamily>::create(dataset(), hints, 31, tr("1/2<110>"), Vector3(1.0f/2.0f, 1.0f/2.0f, 0.0f), Color(0.2f,0.2f,1)));
	cubicDiaPattern->addBurgersVectorFamily(DataOORef<BurgersVectorFamily>::create(dataset(), hints, 32, tr("1/6<112>"), Vector3(1.0f/6.0f, 1.0f/6.0f, 2.0f/6.0f), Color(0,1,0)));
	cubicDiaPattern->addBurgersVectorFamily(DataOORef<BurgersVectorFamily>::create(dataset(), hints, 33, tr("1/6<110>"), Vector3(1.0f/6.0f, 1.0f/6.0f, 0.0f), Color(1,0,1)));
	cubicDiaPattern->addBurgersVectorFamily(DataOORef<BurgersVectorFamily>::create(dataset(), hints, 34, tr("1/3<111>"), Vector3(1.0f/3.0f, 1.0f/3.0f, 1.0f/3.0f), Color(0,1,1)));
	...
	hexDiaPattern->addBurgersVectorFamily(DataOORef<BurgersVectorFamily>::create(dataset(), hints));
	hexDiaPattern->addBurgersVectorFamily(DataOORef<BurgersVectorFamily>::create(dataset(), hints, 41, tr("1/3<1-210>"), Vector3(sqrt(0.5f), 0.0f, 0.0f), Color(0,1,0)));
	hexDiaPattern->addBurgersVectorFamily(DataOORef<BurgersVectorFamily>::create(dataset(), hints, 42, tr("<0001>"), Vector3(0.0f, 0.0f, sqrt(4.0f/3.0f)), Color(0.2f,0.2f,1)));
	hexDiaPattern->addBurgersVectorFamily(DataOORef<BurgersVectorFamily>::create(dataset(), hints, 43, tr("<1-100>"), Vector3(0.0f, sqrt(3.0f/2.0f), 0.0f), Color(1,0,1)));
	hexDiaPattern->addBurgersVectorFamily(DataOORef<BurgersVectorFamily>::create(dataset(), hints, 44, tr("1/3<1-100>"), Vector3(0.0f, sqrt(3.0f/2.0f)/3.0f, 0.0f), Color(1,0.5f,0)));
