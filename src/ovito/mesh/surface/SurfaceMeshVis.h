...
public:
	...
	class OVITO_MESH_EXPORT PrepareSurfaceEngine : public AsynchronousTask<DataOORef<const TriMeshObject>, DataOORef<const TriMeshObject>, std::vector<ColorA>, std::vector<size_t>, bool, PipelineStatus>
	{
	public:
		...
		const DataOORef<TriMeshObject>& outputMesh() { return _outputMesh; }

		/// Returns the generated output triangle mesh for the surface.
		const DataOORef<TriMeshObject>& capPolygonsMesh() { return _capPolygonsMesh; }
	...
	protected:
		...
		DataOORef<TriMeshObject> _outputMesh;		///< The output mesh generated by clipping the surface mesh at the cell boundaries.
		DataOORef<TriMeshObject> _capPolygonsMesh;	///< The output mesh containing the generated cap polygons.
