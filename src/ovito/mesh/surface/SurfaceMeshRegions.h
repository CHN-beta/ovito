...
class OVITO_MESH_EXPORT SurfaceMeshRegions : public PropertyContainer
{
	...
	public:
		...
		virtual PropertyPtr createStandardPropertyInternal(DataSet* dataset, size_t regionCount, int type, bool initializeMemory, ExecutionContext executionContext, const ConstDataObjectPath& containerPath) const override;
