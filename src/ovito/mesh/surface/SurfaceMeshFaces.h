...
class OVITO_MESH_EXPORT SurfaceMeshFaces : public PropertyContainer
{
	...
	public:
		...
		virtual PropertyPtr createStandardPropertyInternal(DataSet* dataset, size_t faceCount, int type, bool initializeMemory, ExecutionContext executionContext, const ConstDataObjectPath& containerPath) const override;
